...
// if (unkonwnNumb1 > unknownNumb2) {
//     console.log (unkonwnNumb1 + " è maggiore di " + unknownNumb2)
// } else {
//     console.log(unknownNumb2 + " è maggiore di " + unkonwnNumb1)
// }
...
// } else if (numb1 - numb2 === 8){
//   console.log("la sottrazione dei numeri fa 8")
// }
...
// let shipping = totalShoppingCart + 10;

// if (totalShoppingCart > 50) {
//     console.log("Price " + totalShoppingCart)
// } else {
...
/* ESERCIZIO EXTRA 3
  ...
  Modifica la risposta precedente includendo questa nuova promozione nell'algoritmo, determinando, usando 
  l'algoritmo del codice precedente, se le spedizioni siano gratuite oppure no e e calcolando il totale.
*/


// let totalShoppingCart = 70;
// let discount = (totalShoppingCart * 0.2);
// let price = totalShoppingCart - discount;
// let shipping = price + 10;
...
/* ESERCIZIO EXTRA 5
  Scrivi un algoritmo che iteri i numeri da 1 a 100, stampandoli in console. Se un valore tuttavia 
  è multiplo di 3 (operatore modulo!), stampa al suo posto la parola "Fizz" e se il numero è multiplo di 5, 
